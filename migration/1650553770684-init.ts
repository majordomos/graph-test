...
export class init1650553770684 implements MigrationInterface {
    name = 'init1650553770684'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "google_id" character varying(300) NOT NULL, "first_name" character varying(300) NOT NULL, "last_name" character varying(300) NOT NULL, "email" character varying(300) NOT NULL, "picture_url" character varying(300) NOT NULL, "user_role" character varying(300) NOT NULL DEFAULT 'employee', "deleted_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
